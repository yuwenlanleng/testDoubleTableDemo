 ...
 * All Rights Reserved
 * 
 * Created at 2011-09-28 14:54:15
 */
 ...
 * @author Qiu Dongyue
 */
public class SingleStudentTableRenderer extends NazcaTableDefaultCellRenderer {
...
//        CheckableItem<InviteCode> item = ((InviteCodeTableModel) table.getModel()).getData(row);
//        if (item != null) {
//            InviteCode student = item.getItem();
//            if (student != null) {
